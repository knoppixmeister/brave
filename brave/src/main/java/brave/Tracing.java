...
public abstract class Tracing implements Closeable {
  ...
  public static final class Builder {
     ...
     * value of an {@link ExtraField extra field}. This means that data will report when either the
     * trace is normally sampled, or secondarily sampled via a custom header.
     *
